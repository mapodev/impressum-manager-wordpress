...
unregister_setting("impressum-manager-settings", "impressum_manager_set_impressum");
unregister_setting("impressum-manager-settings", "impressum_manager_language_of_impressum");
unregister_setting("impressum-manager-settings", "impressum_manager_general_privacy_policy");
unregister_setting("impressum-manager-settings", "impressum_manager_policy_facebook");
unregister_setting("impressum-manager-settings", "impressum_manager_policy_google_analytics");
unregister_setting("impressum-manager-settings", "impressum_manager_policy_google_adsense");
unregister_setting("impressum-manager-settings", "impressum_manager_policy_twitter");
unregister_setting("impressum-manager-settings", "impressum_manager_policy_google_plus");
unregister_setting("impressum-manager-settings", "impressum_manager_page");
unregister_setting("impressum-manager-settings", "impressum_manager_disabled");
unregister_setting("impressum-manager-settings", "impressum_manager_extra_field");
unregister_setting("impressum-manager-settings", "impressum_manager_noindex");
unregister_setting("impressum-manager-settings", "impressum_manager_show_email_as_image");
unregister_setting("impressum-manager-settings", "impressum_manager_source_from");
unregister_setting("impressum-manager-settings", "impressum_manager_powered_by");
